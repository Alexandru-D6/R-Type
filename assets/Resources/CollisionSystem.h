...
private:
    ...
    static bool overlapVertical(const glm::ivec4 &a, const glm::ivec4 &b, const glm::vec2 &posA, const glm::vec2 &posB);
    static bool overlapHorizontal(const glm::ivec4 &a, const glm::ivec4 &b, const glm::vec2 &posA, const glm::vec2 &posB);
