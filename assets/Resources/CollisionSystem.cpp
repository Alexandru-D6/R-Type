...
bool CollisionSystem::isColliding(const Collision* a, const glm::ivec2 &offset) {
...
bool CollisionSystem::searchForCollision(const Collision* a, const Collision* b, const glm::ivec2 &offset) {
