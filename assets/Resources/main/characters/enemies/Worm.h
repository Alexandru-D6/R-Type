...
private:
	...
	glm::vec2 Routes[7][48] = {  { glm::vec2(224.0,23),glm::vec2(306.0,25),glm::vec2(318.0,28),glm::vec2(327.0,32),glm::vec2(335.0,39),glm::vec2(342.0,48),glm::vec2(343.0,68),glm::vec2(344.0,79),glm::vec2(344.0,58),glm::vec2(349.0,90),glm::vec2(356.0,99),glm::vec2(366.0,106),glm::vec2(378.0,110),glm::vec2(389.0,110),glm::vec2(397.0,108),glm::vec2(408.0,103),glm::vec2(417.0,96),glm::vec2(423.0,85),glm::vec2(426.0,74),glm::vec2(426.0,62),glm::vec2(423.0,51),glm::vec2(416.0,41),glm::vec2(407.0,33),glm::vec2(397.0,28),glm::vec2(385.0,26),glm::vec2(60.0,23),glm::vec2(43.0,27),glm::vec2(33.0,33),glm::vec2(25.0,42),glm::vec2(20.0,53),glm::vec2(18.0,65),glm::vec2(19.0,76),glm::vec2(24.0,87),glm::vec2(31.0,96),glm::vec2(41.0,103),glm::vec2(53.0,107),glm::vec2(64.0,107),glm::vec2(72.0,105),glm::vec2(83.0,100),glm::vec2(92.0,93),glm::vec2(98.0,82),glm::vec2(101.0,71),glm::vec2(110.0,55),glm::vec2(120.0,44),glm::vec2(132.0,35),glm::vec2(146.0,29),glm::vec2(162.0,25),glm::vec2(224.0,23) }
