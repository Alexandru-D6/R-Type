...
void GameScene::init() {
	...
	cFactory->spawnCharacter(CharacterFactory::CharacterAvailable::cEnemy2, glm::vec2(INIT_PLAYER_X_TILES * map->getTileSize()+150, INIT_PLAYER_Y_TILES * map->getTileSize()+100));
